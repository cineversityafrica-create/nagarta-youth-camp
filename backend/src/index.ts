...
app.get('/admin/registrations/:id/idcard', requireAdminSession, async (req, res) => {
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; -webkit-print-color-adjust:exact; print-color-adjust:exact; }
    ...
    .wm { position:absolute; left:50%; top:55%; transform:translate(-50%,-50%); width:82mm; max-width:none; opacity:.08; z-index:0; pointer-events:none; }
    ...
    .pic { width:32mm; height:32mm; object-fit:cover; border-radius:2.5mm; border:.8mm solid #27c1ca; margin:2.5mm auto 1.5mm; display:block; }
