...
app.get('/admin/registrations/:id/idcard', requireAdminSession, async (req, res) => {
  ...
  <style>
    ...
    * { box-sizing:border-box; margin:0; padding:0; -webkit-print-color-adjust:exact; print-color-adjust:exact; }
    ...
    .top img { height:18mm; object-fit:contain; margin-bottom:.8mm; }
    ...
    .pic { width:30mm; height:30mm; object-fit:cover; border-radius:2.5mm; border:.8mm solid #27c1ca; margin:2mm auto 1.5mm; display:block; }
